...
reachable. Uses urllib.request.urlopen from the Python standard library.
...
ENDPOINTS = [
    ...
    {
        "name": "CrossRef REST",
        "url": "https://api.crossref.org/works/10.1109/CVPR.2016.90",
        "timeout": 10,
    ...
    },
    {
        ...
        "timeout": 10,
        "affected": "arXiv downloads in format-converter",
    },
]
